...
# Creamos una lista inicial de películas
...
# Imprimimos el elemento eliminado y la lista resultante
...
# Aquí eliminamos el primer elemento (índice 0)
# y lo guardamos en una variable para "rescater ese dato""
